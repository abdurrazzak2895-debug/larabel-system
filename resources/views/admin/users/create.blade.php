...
<div class="max-w-2xl">
    <div class="flex items-center gap-3 mb-6">
        ...
        <div>
            ...
            <p class="text-sm text-slate-500 mt-0.5">Add a new platform user and assign them to an agency.</p>
        </div>
    </div>
    ...
    <div class="bg-white rounded-2xl border border-slate-200 shadow-sm p-6">
        <form method="POST" action="{{ route('admin.users.store') }}" class="space-y-5">
            ...
            <div>
                ...
                <input type="number" name="portal_booking_fee" id="portal_booking_fee" min="0" step="0.01" value="{{ old('portal_booking_fee') }}" placeholder="Leave blank for agency default" class="w-full rounded-xl border-slate-200 text-sm focus:border-brand-500 focus:ring-brand-500">
